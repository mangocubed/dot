pub mod config {
    ...
    pub use leptos::config::{LeptosOptions, get_configuration as get_leptos_config};

    pub static SESSION_CONFIG: LazyLock<SessionConfig> = LazyLock::new(SessionConfig::load);
